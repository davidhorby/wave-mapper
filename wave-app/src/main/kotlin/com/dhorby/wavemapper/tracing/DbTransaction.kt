...
data class DbTransaction(
    ...
    val labels: Map<String, String> = if (true) mapOf(ROUTING_GROUP_LABEL to response.consumer.toString())
    else if (request is RequestWithRoute) mapOf(ROUTING_GROUP_LABEL to request.xUriTemplate.toString())
    else emptyMap()
) {
